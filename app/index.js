...
client.on('guildCreate', guild => {
  ...
  client.on("ready", () => {
      client.user.setActivity("tB youtube", {
        status: "DND",
        type: "WATCHING",
...
client.on('message', message => {
    client.user.setActivity(`${client.guilds.cache.size} Guilds and ${client.users.cache.size} Users | g!help`, {
      status: "online",
      type: "STREAMING",
      url: "https://twitch.tv/dubrin"
    })
...
client.login('Njk5OTI2Njk0NTQ2NjM2ODAw.Xpbfhw.sK1wo9-hPQg5rvgPvnZ2QmWwlMc')
